...
public class DataBase {
    public static void Hello(){
        try(Connection c= DriverManager.getConnection("jdbc:h2:tcp://localhost/~/test", "Miruna", "parola");) {
            ...
            s.executeUpdate(string);
            string="INSERT INTO rute VALUES('Theodor Pallady',17,'Constanta','Orhideelor',4,'Bucuresti','Mercedes','Tourismo',52,4500)";
            s.executeUpdate(string);
            string="INSERT INTO rute VALUES('Viorelelor',4,'Oradea','Constantin Brancoveanu',7,'Brasov','Volvo','SC7',35,6000)";
            s.executeUpdate(string);
            string="INSERT INTO rute VALUES('Ion Creanga',2,'Cluj','Mihai Bravu',23,'Covasna','Irizar','i6',70,7001)";
            s.executeUpdate(string);
            ...
            s.executeUpdate(string);
            string="INSERT INTO soferi VALUES('Mircea Alexandru','Ion Creanga',6,9001,'C',7)";
            s.executeUpdate(string);
            string="INSERT INTO soferi VALUES('Alin Razmerita','Mircea Voda',2,4326,'D',9)";
            s.executeUpdate(string);
            string="INSERT INTO soferi VALUES('George Anania','Roman Voda',54,8210,'B',8)";
            s.executeUpdate(string);
            string="INSERT INTO soferi VALUES('Petru Bandur','Bogdan Dragos',56,9010,'B',18)";
            s.executeUpdate(string);
